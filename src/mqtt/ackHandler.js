...
export async function handleAck(topic, payload) {
  ...
  console.log("📩 ACK RAW:", payload.toString());
  let data;
  try {
    data = JSON.parse(payload.toString());
    console.log("✅ ACK parsed:", data);
  } catch {
    return;
  }
  ...
  console.log("🧾 Command update result:", res);
  ...
  console.log("🚀 EMITTING ACK TO USER:", device.owner.toString());
}